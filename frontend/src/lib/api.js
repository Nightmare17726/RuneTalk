...
export const quizAPI = {
  generate: (chapterId) => api.post(`/quizzes/generate/${chapterId}`),
  submit: (data) => api.post('/quizzes/submit', data),
  getResults: (chapterId) => api.get(`/quizzes/chapter/${chapterId}`),
...
export const userAPI = {
  ...
  deleteDevice: (id) => api.delete(`/users/devices/${id}`),
};
...
export const adminAPI = {
  ...
  getRevenue: (period) => api.get('/admin/revenue', { params: { period } }),
  getAIUsage: (period) => api.get('/admin/ai-usage', { params: { period } }),
  getStats: () => api.get('/admin/stats'),
  getContent: () => api.get('/admin/content/recent'),
